...
namespace GoogolTechGTSCard_6.GTS
{
	...
	/// 【二次封装】固高GTS系列运动控制卡运动卡控制类：初始化运动卡和更新IO
	/// </summary>
	public class GoogolTechGTSCard_v1
	{
		...
		public GoogolTechGTSCard_v1(short TargetCardNumber, short TotalAxises,
		...
		public class GTSAxisControl
		{
			...
			/// 运动控制卡号
			/// </summary>
			private short CardNumber = GoogolTechGTSCard_v1.CardNumber;
				...
				int TargetPulsePerRound = 10000, int TargetScrewPitchInMM = 10)
			{
				...
				try
				{
						...
						|| (DLLPassword == "彭东南"))
					{
						...
						if (TargetAxis < 1 || TargetAxis > GoogolTechGTSCard_v1.TotalAxisesOfCard)
						{
							MessageBox.Show("The current motion card just support " +
								GoogolTechGTSCard_v1.TotalAxisesOfCard
